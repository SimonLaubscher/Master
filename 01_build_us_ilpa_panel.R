# ============================================================
# 01_build_us_ilpa_panel
# Purpose:
# Build the US industry-year productivity panel used in the thesis.
#
# This script:
# - reads raw BLS/ILPA Excel files
# - drops totals and government industries
# - computes labor productivity growth
# - keeps nominal value added for weighting
# - reshapes VA growth contributions
# - merges everything into one final panel
# - exports one final dataset for later analysis
# ============================================================
...
if (!file.exists(CONTRIB_FILE)) stop("Contribution file not found: ", CONTRIB_FILE)
